...
<html lang="en">
    ...
    <body id="login-page">
        ...
        <nav class="navbar navbar-light bg-light">
            ...
            <div id="barra">
                <input class="form-control mr-sm-2" type="search" placeholder="Busque restaurante..." aria-label="Search">
            </div>
            <div>
              <a id="texto">Olá, Seja bem-vindo!!</a>  
        ...
        <div class="list-group">
            <table class="table">
                ...
                <tbody>
                    <c:forEach items="${listaRestaurante}" var="atributo">
                        <tr>
                            <td>${atributo.razaoSocial}</td>
